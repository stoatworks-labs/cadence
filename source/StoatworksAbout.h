/*
 * Stoatworks Labs - About window data for Cadence.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Cadence is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only cadence
...
{
    inline constexpr auto name = "Cadence";
    inline constexpr auto slug = "cadence";
    inline constexpr auto hook = "Interlace, pulldown and every way a deinterlacer gets it wrong, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/cadence/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/cadence";
