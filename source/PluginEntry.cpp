/**
	...
	`CFFGLPluginInfo` that Cadence.cpp registers at static-initialisation
	...
	binary: which build it is.
		...
		strings Cadence.bundle/Contents/MacOS/Cadence | grep cadence
*/

extern "C" const char* CadenceBuildStamp()
{
	return "cadence " CADENCE_VERSION " built " __DATE__ " " __TIME__;
}
